/*
  ...
  Copyright (c) 2012 Aron Homberg (minor changes)
  All rights reserved.

  Warning: This grammar is known to be buggy.
  Complex ECMAScript 5 scripts cannot be parsed.
  e.g. jQuery 1.8.1 won't parse. Grammar needs work.
*/
grammar JavaScript;
